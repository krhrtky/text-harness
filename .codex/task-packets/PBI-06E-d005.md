...
task_packet:
  ...
  active_pbi: "PBI-06E"
  depends_on: "PBI-06D"
  outcome: "D005用語mapping contractを提供"
  owned_paths: ["packages/readability-core/src/rules/D005*", "packages/readability-core/test/deterministic/D005*"]
  acceptance_command: "pnpm --filter @text-harness/readability-core test -- deterministic/D005.contract.test.ts"
  expected_red: null
