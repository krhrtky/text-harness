...
task_packet:
  ...
  active_pbi: "PBI-06A"
  depends_on: "PBI-06"
  outcome: "D001文体混在contractを提供"
  owned_paths: ["packages/readability-core/src/rules/D001*", "packages/readability-core/test/deterministic/D001*"]
  acceptance_command: "pnpm --filter @text-harness/readability-core test -- deterministic/D001.contract.test.ts"
  expected_red: null
  red_registration_gate: "PBI開始時、依存PBI完了後かつ実装変更前に、実在する失敗test command・exit code・完全一致signatureを登録する"
  acceptance: ["AC-D001-01", "D001-P01/N01/B01/F01"]
