...
task_packet:
  ...
  active_pbi: "PBI-06G"
  depends_on: "PBI-06F"
  outcome: "D007固定二重否定contractを提供"
  owned_paths: ["packages/readability-core/src/rules/D007*", "packages/readability-core/test/deterministic/D007*"]
  acceptance_command: "pnpm --filter @text-harness/readability-core test -- deterministic/D007.contract.test.ts"
  expected_red: null
