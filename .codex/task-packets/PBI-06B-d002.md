...
task_packet:
  ...
  active_pbi: "PBI-06B"
  depends_on: "PBI-06A"
  outcome: "D002 Unicode normalization contractを提供"
  owned_paths: ["packages/readability-core/src/rules/D002*", "packages/readability-core/test/deterministic/D002*"]
  acceptance_command: "pnpm --filter @text-harness/readability-core test -- deterministic/D002.contract.test.ts"
  expected_red: null
  red_registration_gate: "PBI開始時、依存PBI完了後かつ実装変更前に、実在する失敗test command・exit code・完全一致signatureを登録する"
  acceptance: ["AC-D002-01", "D002-P01/N01/B01/F01"]
