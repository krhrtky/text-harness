...
```yaml
task_packet:
  source_links: ["docs/requirements/normative-contract-matrix.json#deterministicRules.D004", "docs/requirements/deterministic-rules.md#rule別oracle", "docs/requirements/readability-mvp.md#ac-d-04-意図的反証", "docs/decisions/DEC-008-d004-observable-precedence.md", "docs/decision-evidence/deterministic-qualification.json"]
  ...
  invariants:
    ...
    - "left-to-right non-overlap mappingで同一startはlongest termを選び、各separated occurrenceを1件報告する"
